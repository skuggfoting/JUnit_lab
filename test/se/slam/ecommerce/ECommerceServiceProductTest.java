...
public final class ECommerceServiceProductTest
{
	...
	@InjectMocks ECommerceService eService;
	...
	//Test delete() in product repository. Should throw run time service exception.
	@Test
	...
	//Test delete() in product repository. Should return null if the exist() invoked after delete()
	@Test
